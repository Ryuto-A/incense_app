...
ActiveRecord::Schema[7.1].define(version: 2025_11_16_091902) do
  ...
  create_table "comments", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "incense_review_id", null: false
    t.text "content"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["incense_review_id"], name: "index_comments_on_incense_review_id"
